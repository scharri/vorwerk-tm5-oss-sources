...
hab_rvt_t *hab_rvt_p = (hab_rvt_t *)0xFFFF8AF8;
...
static enum magic_key get_magic_key (void)
{
	...
	// MICHAL - disabled magic keys check, as it was choosing wrong cmdline
...
//	const char *mtdprefix[] = { "root=/dev/mtdblock", "root=ubi0:rootfs"};
	...
	// MICHAL - starting RTC block is done now in Image Chooser
	...
	o += (m - cmdline);
	// 254:0 is rootfs0, 254:8 is rootfs1
	*o = '8';
