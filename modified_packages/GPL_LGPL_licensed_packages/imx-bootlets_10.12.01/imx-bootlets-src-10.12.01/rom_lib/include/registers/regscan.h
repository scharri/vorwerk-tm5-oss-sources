 ...
 * Filename: regscan.h
 *
 * Description: PIO Registers for CAN interface
 *
 * Xml Revision: 1.11
 *
...
/* --- Register HW_CAN_MCR, field DOZE */

#define BP_CAN_MCR_DOZE      18
#define BM_CAN_MCR_DOZE      0x00040000

#define BF_CAN_MCR_DOZE(v)   (((v) << 18) & BM_CAN_MCR_DOZE)
#ifndef __LANGUAGE_ASM__
#define BW_CAN_MCR_DOZE(n, v)   BFn_CS1(CAN_MCR, n, DOZE, v)
#endif
...
/*
 * HW_CAN_TCR - Test Configuration Register
 */
#ifndef __LANGUAGE_ASM__
typedef union
{
...
/*
 * constants & macros for entire multi-block HW_CAN_TCR register
 */
#define HW_CAN_TCR_ADDR(x)      (REGS_CAN_BASE(x) + 0xc)

#ifndef __LANGUAGE_ASM__
#define HW_CAN_TCR(x)           (*(volatile hw_can_tcr_t *) HW_CAN_TCR_ADDR(x))
#define HW_CAN_TCR_RD(x)      (HW_CAN_TCR(x).U)
#define HW_CAN_TCR_WR(x, v)     (HW_CAN_TCR(x).U = (v))
#define HW_CAN_TCR_SET(x, v)    (HW_CAN_TCR_WR(x, HW_CAN_TCR_RD(x) |  (v)))
#define HW_CAN_TCR_CLR(x, v)    (HW_CAN_TCR_WR(x, HW_CAN_TCR_RD(x) & ~(v)))
#define HW_CAN_TCR_TOG(x, v)    (HW_CAN_TCR_WR(x, HW_CAN_TCR_RD(x) ^  (v)))
#endif


/*
 * constants & macros for individual HW_CAN_TCR bitfields
 */
/* --- Register HW_CAN_TCR, field RSVD1 */

#define BP_CAN_TCR_RSVD1      11
#define BM_CAN_TCR_RSVD1      0xFFFFF800

#ifndef __LANGUAGE_ASM__
#define BF_CAN_TCR_RSVD1(v)   ((((reg32_t) v) << 11) & BM_CAN_TCR_RSVD1)
#else
#define BF_CAN_TCR_RSVD1(v)   (((v) << 11) & BM_CAN_TCR_RSVD1)
#endif
/* --- Register HW_CAN_TCR, field TRD */

#define BP_CAN_TCR_TRD      10
#define BM_CAN_TCR_TRD      0x00000400

#define BF_CAN_TCR_TRD(v)   (((v) << 10) & BM_CAN_TCR_TRD)
#ifndef __LANGUAGE_ASM__
#define BW_CAN_TCR_TRD(n, v)   BFn_CS1(CAN_TCR, n, TRD, v)
#endif

/* --- Register HW_CAN_TCR, field BITCLS */

#define BP_CAN_TCR_BITCLS      9
#define BM_CAN_TCR_BITCLS      0x00000200

#define BF_CAN_TCR_BITCLS(v)   (((v) << 9) & BM_CAN_TCR_BITCLS)
#ifndef __LANGUAGE_ASM__
#define BW_CAN_TCR_BITCLS(n, v)   BFn_CS1(CAN_TCR, n, BITCLS, v)
#endif

/* --- Register HW_CAN_TCR, field DSCACK */

#define BP_CAN_TCR_DSCACK      8
#define BM_CAN_TCR_DSCACK      0x00000100

#define BF_CAN_TCR_DSCACK(v)   (((v) << 8) & BM_CAN_TCR_DSCACK)
#ifndef __LANGUAGE_ASM__
#define BW_CAN_TCR_DSCACK(n, v)   BFn_CS1(CAN_TCR, n, DSCACK, v)
#endif

/* --- Register HW_CAN_TCR, field RSVD0 */

#define BP_CAN_TCR_RSVD0      0
#define BM_CAN_TCR_RSVD0      0x000000FF

#define BF_CAN_TCR_RSVD0(v)   (((v) << 0) & BM_CAN_TCR_RSVD0)
...
/*
 * HW_CAN_MB0 - Rx Individual Mask Registers
 */
#ifndef __LANGUAGE_ASM__
typedef union
{
...
/*
 * constants & macros for entire multi-block HW_CAN_MB0 register
 */
#define HW_CAN_MB0_ADDR(x)      (REGS_CAN_BASE(x) + 0x80)

#ifndef __LANGUAGE_ASM__
#define HW_CAN_MB0(x)           (*(volatile hw_can_mb0_t *) HW_CAN_MB0_ADDR(x))
#define HW_CAN_MB0_RD(x)      (HW_CAN_MB0(x).U)
#define HW_CAN_MB0_WR(x, v)     (HW_CAN_MB0(x).U = (v))
#define HW_CAN_MB0_SET(x, v)    (HW_CAN_MB0_WR(x, HW_CAN_MB0_RD(x) |  (v)))
#define HW_CAN_MB0_CLR(x, v)    (HW_CAN_MB0_WR(x, HW_CAN_MB0_RD(x) & ~(v)))
#define HW_CAN_MB0_TOG(x, v)    (HW_CAN_MB0_WR(x, HW_CAN_MB0_RD(x) ^  (v)))
#endif


/*
 * constants & macros for individual HW_CAN_MB0 bitfields
 */
/* --- Register HW_CAN_MB0, field MI */

#define BP_CAN_MB0_MI      0
#define BM_CAN_MB0_MI      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_CAN_MB0_MI(v)   ((reg32_t) v)
#else
#define BF_CAN_MB0_MI(v)   (v)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_CAN_MB0_MI(n, v)   (HW_CAN_MB0(n).B.MI = (v))
#endif



/*
 * HW_CAN_RXIMR0 - Rx Individual Mask Registers
 */
#ifndef __LANGUAGE_ASM__
typedef union
{
...
/*
 * constants & macros for entire multi-block HW_CAN_RXIMR0 register
 */
#define HW_CAN_RXIMR0_ADDR(x)      (REGS_CAN_BASE(x) + 0x880)

#ifndef __LANGUAGE_ASM__
#define HW_CAN_RXIMR0(x)           (*(volatile hw_can_rximr0_t *) HW_CAN_RXIMR0_ADDR(x))
#define HW_CAN_RXIMR0_RD(x)      (HW_CAN_RXIMR0(x).U)
#define HW_CAN_RXIMR0_WR(x, v)     (HW_CAN_RXIMR0(x).U = (v))
#define HW_CAN_RXIMR0_SET(x, v)    (HW_CAN_RXIMR0_WR(x, HW_CAN_RXIMR0_RD(x) |  (v)))
#define HW_CAN_RXIMR0_CLR(x, v)    (HW_CAN_RXIMR0_WR(x, HW_CAN_RXIMR0_RD(x) & ~(v)))
#define HW_CAN_RXIMR0_TOG(x, v)    (HW_CAN_RXIMR0_WR(x, HW_CAN_RXIMR0_RD(x) ^  (v)))
#endif


/*
 * constants & macros for individual HW_CAN_RXIMR0 bitfields
 */
/* --- Register HW_CAN_RXIMR0, field MI */

#define BP_CAN_RXIMR0_MI      0
#define BM_CAN_RXIMR0_MI      0xFFFFFFFF

#ifndef __LANGUAGE_ASM__
#define BF_CAN_RXIMR0_MI(v)   ((reg32_t) v)
#else
#define BF_CAN_RXIMR0_MI(v)   (v)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_CAN_RXIMR0_MI(n, v)   (HW_CAN_RXIMR0(n).B.MI = (v))
#endif
