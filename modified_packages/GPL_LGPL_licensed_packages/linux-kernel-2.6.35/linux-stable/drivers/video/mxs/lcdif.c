...
{
	/* configure LCD_RESET signal */
	gpio_request(MXS_PIN_TO_GPIO(PINID_ENET0_RX_EN), "ENET0_RX_EN");
	gpio_direction_output(MXS_PIN_TO_GPIO(PINID_ENET0_RX_EN), 0);
	...
	gpio_set_value(MXS_PIN_TO_GPIO(PINID_ENET0_RX_EN), 1); // high = bring up
	mdelay (5);
