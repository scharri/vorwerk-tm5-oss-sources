...
#define REGS_I2C_BASE (REGS_BASE + 0x00058000)	//I2C0
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_RD_QUEUE_IRQ(v)   BF_CS1(I2C_CTRL1, RD_QUEUE_IRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_WR_QUEUE_IRQ(v)   BFn_CS1(I2C_CTRL1, WR_QUEUE_IRQ, v)
#endif
 ...
 */
#define HW_I2C_QUEUECTRL_ADDR      (REGS_I2C_BASE + 0x00000060)
#define HW_I2C_QUEUECTRL_SET_ADDR  (REGS_I2C_BASE + 0x00000064)
#define HW_I2C_QUEUECTRL_CLR_ADDR  (REGS_I2C_BASE + 0x00000068)
#define HW_I2C_QUEUECTRL_TOG_ADDR  (REGS_I2C_BASE + 0x0000006C)

#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUECTRL           (*(volatile hw_i2c_queuectrl_t *) HW_I2C_QUEUECTRL_ADDR)
#define HW_I2C_QUEUECTRL_RD()      (HW_I2C_QUEUECTRL.U)
#define HW_I2C_QUEUECTRL_WR(v)     (HW_I2C_QUEUECTRL.U = (v))
#define HW_I2C_QUEUECTRL_SET(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECTRL_SET_ADDR) = (v))
#define HW_I2C_QUEUECTRL_CLR(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECTRL_CLR_ADDR) = (v))
#define HW_I2C_QUEUECTRL_TOG(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_RD_THRESH(v)   BF_CS1(I2C_QUEUECTRL, RD_THRESH, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_WR_THRESH(v)   BF_CS1(I2C_QUEUECTRL, WR_THRESH, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_QUEUE_RUN(v)   BF_CS1(I2C_QUEUECTRL, QUEUE_RUN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_RD_CLEAR(v)   BF_CS1(I2C_QUEUECTRL, RD_CLEAR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_WR_CLEAR(v)   BF_CS1(I2C_QUEUECTRL, WR_CLEAR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_PIO_QUEUE_MODE(v)   BF_CS1(I2C_QUEUECTRL, PIO_QUEUE_MODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_RD_QUEUE_IRQ_EN(v)   BF_CS1(I2C_QUEUECTRL, RD_QUEUE_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_WR_QUEUE_IRQ_EN(v)   BF_CS1(I2C_QUEUECTRL, WR_QUEUE_IRQ_EN, v)
#endif
 ...
 */
#define HW_I2C_QUEUESTAT_ADDR      (REGS_I2C_BASE + 0x00000070)

#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUESTAT           (*(volatile hw_i2c_queuestat_t *) HW_I2C_QUEUESTAT_ADDR)
#define HW_I2C_QUEUESTAT_RD()      (HW_I2C_QUEUESTAT.U)
#endif
 ...
 */
#define HW_I2C_QUEUECMD_ADDR      (REGS_I2C_BASE + 0x00000080)
#define HW_I2C_QUEUECMD_SET_ADDR  (REGS_I2C_BASE + 0x00000084)
#define HW_I2C_QUEUECMD_CLR_ADDR  (REGS_I2C_BASE + 0x00000088)
#define HW_I2C_QUEUECMD_TOG_ADDR  (REGS_I2C_BASE + 0x0000008C)

#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUECMD           (*(volatile hw_i2c_queuecmd_t *) HW_I2C_QUEUECMD_ADDR)
#define HW_I2C_QUEUECMD_RD()      (HW_I2C_QUEUECMD.U)
#define HW_I2C_QUEUECMD_WR(v)     (HW_I2C_QUEUECMD.U = (v))
#define HW_I2C_QUEUECMD_SET(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECMD_SET_ADDR) = (v))
#define HW_I2C_QUEUECMD_CLR(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECMD_CLR_ADDR) = (v))
#define HW_I2C_QUEUECMD_TOG(v)    ((*(volatile reg32_t *) HW_I2C_QUEUECMD_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_PRE_ACK(v)   BF_CS1(I2C_QUEUECMD, PRE_ACK, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_ACKNOWLEDGE(v)   BF_CS1(I2C_QUEUECMD, ACKNOWLEDGE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_SEND_NAK_ON_LAST(v)   BF_CS1(I2C_QUEUECMD, SEND_NAK_ON_LAST, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_MULTI_MASTER(v)   BF_CS1(I2C_QUEUECMD, MULTI_MASTER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_CLOCK_HELD(v)   BF_CS1(I2C_QUEUECMD, CLOCK_HELD, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_RETAIN_CLOCK(v)   BF_CS1(I2C_QUEUECMD, RETAIN_CLOCK, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_POST_SEND_STOP(v)   BF_CS1(I2C_QUEUECMD, POST_SEND_STOP, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_PRE_SEND_START(v)   BF_CS1(I2C_QUEUECMD, PRE_SEND_START, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_SLAVE_ADDRESS_ENABLE(v)   BF_CS1(I2C_QUEUECMD, SLAVE_ADDRESS_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_MASTER_MODE(v)   BF_CS1(I2C_QUEUECMD, MASTER_MODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_DIRECTION(v)   BF_CS1(I2C_QUEUECMD, DIRECTION, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_XFER_COUNT(v)   BF_CS1(I2C_QUEUECMD, XFER_COUNT, v)
#endif
 ...
 */
#define HW_I2C_QUEUEDATA_ADDR      (REGS_I2C_BASE + 0x00000090)

#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUEDATA           (*(volatile hw_i2c_queuedata_t *) HW_I2C_QUEUEDATA_ADDR)
#define HW_I2C_QUEUEDATA_RD()      (HW_I2C_QUEUEDATA.U)
#endif
 ...
 */
#define HW_I2C_DATA_ADDR      (REGS_I2C_BASE + 0x000000A0)
 ...
 */
#define HW_I2C_DEBUG0_ADDR      (REGS_I2C_BASE + 0x000000B0)
#define HW_I2C_DEBUG0_SET_ADDR  (REGS_I2C_BASE + 0x000000B4)
#define HW_I2C_DEBUG0_CLR_ADDR  (REGS_I2C_BASE + 0x000000B8)
#define HW_I2C_DEBUG0_TOG_ADDR  (REGS_I2C_BASE + 0x000000BC)
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG0_STATE_VALUE(v)   BF_CS1(I2C_DEBUG0, STATE_VALUE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG0_STATE_LATCH(v)   BF_CS1(I2C_DEBUG0, STATE_LATCH, v)
#endif
 ...
 */
#define HW_I2C_DEBUG1_ADDR      (REGS_I2C_BASE + 0x000000C0)
#define HW_I2C_DEBUG1_SET_ADDR  (REGS_I2C_BASE + 0x000000C4)
#define HW_I2C_DEBUG1_CLR_ADDR  (REGS_I2C_BASE + 0x000000C8)
#define HW_I2C_DEBUG1_TOG_ADDR  (REGS_I2C_BASE + 0x000000CC)
 ...
 */
#define HW_I2C_VERSION_ADDR      (REGS_I2C_BASE + 0x000000D0)
