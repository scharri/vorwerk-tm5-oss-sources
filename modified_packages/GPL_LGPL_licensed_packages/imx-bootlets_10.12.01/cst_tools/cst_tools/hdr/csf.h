...
#define ERROR_CMDHEADER_NOT_FIRST       (CAL_LAST_ERROR - 11)
...
#define STR_ILLEGAL (" is illegal for given HAB version")
...
#define STR_BINDING_UID ("Binding UID")
...
/* HAB3 and HAB4 macros */
#define HAB3 (0x30)
#define HAB4 (0x40)

/* Length offset in header for both hab3 and hab4 */
...
extern uint32_t g_sig_format;        /* Holds default signature format       */
...
extern int32_t create_sig_file(char *file, char *cert_file, 
        sig_fmt_t sig_fmt, sig_alg_t sig_alg, uint8_t *data, 
        int32_t data_size);
...
/* Returns hash alg for hab3 using alg type, engine and eng cfg */
extern int32_t get_hab3_hash_alg(const int32_t hash_alg, 
                const int32_t engine, const eng_cfg_t engine_cfg);
...
extern int32_t cmd_handler_writedata(command_t *cmd);
extern int32_t cmd_handler_clearmask(command_t *cmd);
extern int32_t cmd_handler_setmask(command_t *cmd);
extern int32_t cmd_handler_checkallclear(command_t *cmd);
extern int32_t cmd_handler_checkallset(command_t *cmd);
extern int32_t cmd_handler_checkanyclear(command_t *cmd);
extern int32_t cmd_handler_checkanyset(command_t *cmd);
extern int32_t cmd_handler_nop(command_t *cmd);
extern int32_t cmd_handler_setmid(command_t *cmd);
