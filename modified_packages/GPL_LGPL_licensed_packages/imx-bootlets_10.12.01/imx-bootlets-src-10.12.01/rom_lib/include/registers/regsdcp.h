 ...
 */
#define HW_DCP_CTRL_ADDR      (0x80028000)
#define HW_DCP_CTRL_SET_ADDR  (0x80028004)
#define HW_DCP_CTRL_CLR_ADDR  (0x80028008)
#define HW_DCP_CTRL_TOG_ADDR  (0x8002800c)
 ...
 */
#define HW_DCP_STAT_ADDR      (0x80028010)
#define HW_DCP_STAT_SET_ADDR  (0x80028014)
#define HW_DCP_STAT_CLR_ADDR  (0x80028018)
#define HW_DCP_STAT_TOG_ADDR  (0x8002801c)
 ...
 */
#define HW_DCP_CHANNELCTRL_ADDR      (0x80028020)
#define HW_DCP_CHANNELCTRL_SET_ADDR  (0x80028024)
#define HW_DCP_CHANNELCTRL_CLR_ADDR  (0x80028028)
#define HW_DCP_CHANNELCTRL_TOG_ADDR  (0x8002802c)
 ...
 */
#define HW_DCP_CAPABILITY0_ADDR      (0x80028030)
 ...
 */
#define HW_DCP_CAPABILITY1_ADDR      (0x80028040)
 ...
 */
#define HW_DCP_CONTEXT_ADDR      (0x80028050)
 ...
 */
#define HW_DCP_KEY_ADDR      (0x80028060)
 ...
 */
#define HW_DCP_KEYDATA_ADDR      (0x80028070)
 ...
 */
#define HW_DCP_PACKET0_ADDR      (0x80028080)
 ...
 */
#define HW_DCP_PACKET1_ADDR      (0x80028090)
 ...
 */
#define HW_DCP_PACKET2_ADDR      (0x800280a0)
 ...
 */
#define HW_DCP_PACKET3_ADDR      (0x800280b0)
 ...
 */
#define HW_DCP_PACKET4_ADDR      (0x800280c0)
 ...
 */
#define HW_DCP_PACKET5_ADDR      (0x800280d0)
 ...
 */
#define HW_DCP_PACKET6_ADDR      (0x800280e0)
...
typedef union
{
    ...
    #define HW_DCP_CHnCMDPTR_ADDR(n)      (0x80028100 + ((n) * 0x40))
...
typedef union
{
    ...
    #define HW_DCP_CHnSEMA_ADDR(n)      (0x80028110 + ((n) * 0x40))
...
typedef union
{
    ...
    #define HW_DCP_CHnSTAT_ADDR(n)      (0x80028120 + ((n) * 0x40))
    #define HW_DCP_CHnSTAT_SET_ADDR(n)  (0x80028124 + ((n) * 0x40))
    #define HW_DCP_CHnSTAT_CLR_ADDR(n)  (0x80028128 + ((n) * 0x40))
    #define HW_DCP_CHnSTAT_TOG_ADDR(n)  (0x8002812c + ((n) * 0x40))
...
typedef union
{
    ...
    #define HW_DCP_CHnOPTS_ADDR(n)      (0x80028130 + ((n) * 0x40))
    #define HW_DCP_CHnOPTS_SET_ADDR(n)  (0x80028134 + ((n) * 0x40))
    #define HW_DCP_CHnOPTS_CLR_ADDR(n)  (0x80028138 + ((n) * 0x40))
    #define HW_DCP_CHnOPTS_TOG_ADDR(n)  (0x8002813c + ((n) * 0x40))
 ...
 */
#define HW_DCP_DBGSELECT_ADDR      (0x80028400)
 ...
 */
#define HW_DCP_DBGDATA_ADDR      (0x80028410)
 ...
 */
#define HW_DCP_PAGETABLE_ADDR      (0x80028420)
 ...
 */
#define HW_DCP_VERSION_ADDR      (0x80028430)
