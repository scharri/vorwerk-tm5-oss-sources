...
wifidirectcmd_gas_comeback_discovery(int argc, char *argv[])
{
    ...
    strncpy(wifidirect_cmd, argv[2], sizeof(wifidirect_cmd));
                              ...
                              t_u16 * ie_len_wifidirect, t_u16 * ie_len_wps)
{
    FILE *config_file = NULL;
    char *line = NULL;
    int i, li = 0, arg_num = 0, ret = 0, wifidirect_level =
    ...
    t_u8 *extra = NULL;
    t_u8 *buffer = pbuf;
    t_u16 cmd_len_wifidirect = 0, cmd_len_wps = 0, tlv_len = 0, extra_len, temp;
    ...
    while (config_get_line(line, MAX_CONFIG_LINE, config_file, &li, &pos)) {
        ...
        if (strcmp(args[0], "wifidirect_config") == 0) {
            ...
            strncpy(wifidirect_ssid, args[1], sizeof(wifidirect_ssid));
...
is_input_valid(valid_inputs cmd, int argc, char *argv[])
{
    ...
    case WIFIDIRECT_GROUP_WIFIDIRECT_DEVICE_NAME:
        ...
        if ((strlen(argv[0]) > 34)) {
            ...
            strcpy(wifidirect_dev_name, argv[0]);
