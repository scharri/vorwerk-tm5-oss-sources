...
// For EMI 200MHz,must enable SSP0 pin drive to 12mA,or the SD boot will fail.
	...
	// try set SD_MODE (ENET_CLK) pin early
	HW_PINCTRL_MUXSEL9_CLR (BM_PINCTRL_MUXSEL9_BANK4_PIN16);
	HW_PINCTRL_MUXSEL9_SET (BM_PINCTRL_MUXSEL9_BANK4_PIN16);	// 11 - GPIO
	HW_PINCTRL_DRIVE18_CLR (0x7);
	HW_PINCTRL_DRIVE18_SET (0x2);					// 010 - 1.8V, 12mA
	HW_PINCTRL_DOE4_SET (0x00010000);	// as output
	HW_PINCTRL_DOUT4_SET (0x00010000);	// output high, Bank 4 pin 16 => 17 bit
#endif
...
int PowerPrep_ConfigurePowerSource( void )
{
	...
	*/
	...
	printf("Configured for 5v only power source.\r\n"
