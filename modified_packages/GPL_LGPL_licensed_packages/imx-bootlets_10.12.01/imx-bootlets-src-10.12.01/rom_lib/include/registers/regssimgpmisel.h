/*
 *
 * Filename: ./regssimgpmisel.h
 *
 * Description: PIO Registers for SIMGPMISEL interface
 *
 * Xml Revision: 1.0
 *
...
#ifndef _SIMGPMISEL_H
#define _SIMGPMISEL_H  1

#include "regs.h"

#ifndef REGS_SIMGPMISEL_BASE
#define REGS_SIMGPMISEL_BASE (REGS_BASE + 0x3c200)
#endif

/*
 *  multi-register-define name HW_SIMGPMISEL_CHANn_CFG
 *              base 0x00000000
 *              count 8
 *              offset 0x4
 */
...
typedef union
{
     ...
     */
    #define HW_SIMGPMISEL_CHANn_CFG_COUNT        8
    #define HW_SIMGPMISEL_CHANn_CFG_ADDR(n)      (0x8003c200 + ((n) * 0x4))
...
/* --- Register HW_SIMGPMISEL_CHANn_CFG, field GANGED_RBB */

#define BP_SIMGPMISEL_CHANn_CFG_GANGED_RBB      8
#define BM_SIMGPMISEL_CHANn_CFG_GANGED_RBB      0x00000100

#define BF_SIMGPMISEL_CHANn_CFG_GANGED_RBB(v)   (((v) << 8) & BM_SIMGPMISEL_CHANn_CFG_GANGED_RBB)
#ifndef __LANGUAGE_ASM__
#define BW_SIMGPMISEL_CHANn_CFG_GANGED_RBB(n, v)  BF_CS1n(SIMGPMISEL_CHANn_CFG, n, GANGED_RBB, v)
#endif

/* --- Register HW_SIMGPMISEL_CHANn_CFG, field DEV_CODE */

#define BP_SIMGPMISEL_CHANn_CFG_DEV_CODE      0
#define BM_SIMGPMISEL_CHANn_CFG_DEV_CODE      0x000000FF
...
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_HY27UF081G2M     0x8
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_HY27UG082G2M     0x9
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_HY27UH084G2M     0xa
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_MT29F2G08AAB     0xb
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_NAND01GW3B       0xc
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_MT29F4G08BAB     0xd
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_TC58NVG1S3BFT00  0xe
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_K9G4G08U0M       0xf
#define BV_SIMGPMISEL_CHANn_CFG_DEV_CODE__NAND_8_K9F8G08U0M       0x10
