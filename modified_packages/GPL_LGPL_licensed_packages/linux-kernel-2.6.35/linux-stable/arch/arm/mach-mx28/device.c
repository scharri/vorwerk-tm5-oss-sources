...
#warning "Select i2c channel 0 PIOQUEUE MODE"
	.pioqueue_mode = 1,
#endif
};
#endif
...
#warning "Select i2c channel 1 PIOQUEUE MODE"
	.pioqueue_mode = 1,
#endif
};
#endif
...
static struct gpmi_nfc_platform_data  gpmi_nfc_platform_data = {
	...
	.max_chip_count          = 2,
	.boot_area_size_in_bytes = 12800 * SZ_1K,
