 ...
 */
#define HW_PWM_CTRL_ADDR      (0x80064000)
#define HW_PWM_CTRL_SET_ADDR  (0x80064004)
#define HW_PWM_CTRL_CLR_ADDR  (0x80064008)
#define HW_PWM_CTRL_TOG_ADDR  (0x8006400c)
...
typedef union
{
    ...
    #define HW_PWM_ACTIVEn_ADDR(n)      (0x80064010 + ((n) * 0x20))
    #define HW_PWM_ACTIVEn_SET_ADDR(n)  (0x80064014 + ((n) * 0x20))
    #define HW_PWM_ACTIVEn_CLR_ADDR(n)  (0x80064018 + ((n) * 0x20))
    #define HW_PWM_ACTIVEn_TOG_ADDR(n)  (0x8006401c + ((n) * 0x20))
...
typedef union
{
    ...
    #define HW_PWM_PERIODn_ADDR(n)      (0x80064020 + ((n) * 0x20))
    #define HW_PWM_PERIODn_SET_ADDR(n)  (0x80064024 + ((n) * 0x20))
    #define HW_PWM_PERIODn_CLR_ADDR(n)  (0x80064028 + ((n) * 0x20))
    #define HW_PWM_PERIODn_TOG_ADDR(n)  (0x8006402c + ((n) * 0x20))
 ...
 */
#define HW_PWM_VERSION_ADDR      (0x80064110)
