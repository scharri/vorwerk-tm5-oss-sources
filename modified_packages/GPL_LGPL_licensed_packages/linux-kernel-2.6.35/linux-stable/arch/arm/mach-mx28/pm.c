...
static int __init mx28_pm_init(void)
{
	...
	suspend_set_ops(&mx28_suspend_ops);
        // mneuwert: Deactivate PSWITCH interrupt handling since PSWITCH is not used in the system.
        //           In the past, ESD on this pin was leading to standby / wake-up cycle
	//init_pswitch();
	return 0;
}
