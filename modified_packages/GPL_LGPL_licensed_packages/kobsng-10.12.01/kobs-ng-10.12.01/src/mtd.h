...
struct mtd_data {
	...
	V1_ROM_BootBlockStruct_t *curr_fcb;
	V1_ROM_BootBlockStruct_t *curr_dbbt28;
...
void bcb_calculate_checksum (V1_ROM_BootBlockStruct_t *fcb);
